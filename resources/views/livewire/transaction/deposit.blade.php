  <main class="flex-grow">
      <div class="mx-auto max-w-2xl px-4 py-10 md:px-6">
          ...
          <form wire:submit.prevent="deposit" class="space-y-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
              ...
              <div class="flex flex-col gap-1">
                  <label for="origin" class="text-sm text-gray-600 font-medium">Costa destinaria</label>
                  <input type="text" id="origin" placeholder="Ex: Conta do Itaú, carteira física..."
          ...
          <div class="mt-8 rounded-xl bg-blue-50 px-5 py-4 text-sm text-blue-900 border border-blue-200">
              <p><strong>Nota:</strong> Depósitos via PIX são processados automaticamente em até 1 minuto.</p>
              <p class="mt-1">Para boletos, o prazo pode ser de até 2 dias úteis.</p>
          </div>
      </div>
  </main>
